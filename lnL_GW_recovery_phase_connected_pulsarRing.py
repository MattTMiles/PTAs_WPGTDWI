...
enterprise_params ={}
enterprise_params.update({p: np.random.uniform(-18,-13) for p in pta.param_names if 'rednoise_log10_A' in p})
enterprise_params.update({p: np.random.uniform(2,6) for p in pta.param_names if 'rednoise_gamma' in p})
