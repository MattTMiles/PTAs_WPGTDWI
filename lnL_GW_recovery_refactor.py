...
from discovery.deterministic import makefourier_binary_pdist_twoD, makefourier_binary_pdist
...
parser.add_argument(
    "--scan-param",
    choices=["gwb_log10_A", "cw_log10_h", "cw_log10_h_2"],
    default="gwb_log10_A",
...
parser.add_argument(
    ...
    type=int,
    default=None,
    help="Seed for NumPy RNG (use same value as notebook to reproduce).",
)
parser.add_argument(
    "--output-root",
    default="lnLs_GWAmp",
...
enterprise_params.update({'cw_cos_inc': 0, 'cw_log10_f0': -8, 'cw_log10_h': -13, 'cw_phi_earth':np.pi, 'cw_psi': np.pi/4.0, 'cw_ra': 0.458, 'cw_sindec': 0.43})
# second det source
enterprise_params.update({'cw2_cos_inc': 0, 'cw2_log10_f0': -7.5, 'cw2_log10_h': -13, 'cw2_phi_earth':np.pi, 'cw2_psi': np.pi/4.0, 'cw2_ra': 0.158, 'cw2_sindec': 0.13})
...
#     def fourier_binary_pdist(f, df, mintoa, pos, log10_h0, log10_f0, ra, sindec, cos_inc, psi, phi_earth, p_dist):
#         h0 = 10**log10_h0
#         f0 = 10**log10_f0
...
#     def fourier_binary_pdist_twoD(f, df, mintoa, pos, log10_h0, log10_f0, ra, sindec, cos_inc, psi, phi_earth, 
#                              log10_h0_2, log10_f0_2, ra_2, sindec_2, cos_inc_2, psi_2, phi_earth_2, p_dist):
...
fourdelay = makefourier_binary_pdist_twoD(pulsarterm=args.pulsar_term)
cwcommon = [
    "cw_sindec", "cw_cos_inc", "cw_log10_f0", "cw_log10_h", "cw_phi_earth", "cw_psi", "cw_ra",
    "cw_sindec_2", "cw_cos_inc_2", "cw_log10_f0_2", "cw_log10_h_2", "cw_phi_earth_2", "cw_psi_2", "cw_ra_2"
]
...
ax.set_title(f"LogL realisations vs {combined_prefix}_{start_real}_{start_real + n_real - 1} F-Disco")
